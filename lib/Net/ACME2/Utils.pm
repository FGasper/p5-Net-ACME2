package Net::ACME2::Utils;

=encoding utf-8

=head1 NAME

Net::ACME2::Utils - utilities for C<Net::ACME>

=head1 SYNOPSIS

    Net::ACME2::Utils::verify_token('blah/blah');     #dies
    Net::ACME2::Utils::verify_token('blah-blah');     #succeeds
